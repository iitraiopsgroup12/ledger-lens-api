...
class RefreshResponse(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr
    new_documents_found: Optional[StrictInt] = None
    document_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["status", "new_documents_found", "document_ids"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "new_documents_found": obj.get("new_documents_found"),
